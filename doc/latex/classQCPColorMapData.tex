...
\index{\-Q\-C\-P\-Color\-Map\-Data@{\-Q\-C\-P\-Color\-Map\-Data}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{\-Q\-C\-P\-Color\-Map\-Data}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Q\-C\-P\-Color\-Map\-Data\-::\-Q\-C\-P\-Color\-Map\-Data} (
...
\index{cell\-To\-Coord@{cell\-To\-Coord}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{cell\-To\-Coord}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::cell\-To\-Coord} (
\begin{DoxyParamCaption}
\item[{int}]{key\-Index, }
...
\begin{DoxyNote}{\-Note}
\-The \hyperlink{classQCPColorMap}{\-Q\-C\-P\-Color\-Map} always displays the data at equal key/value intervals, even if the key or value axis is set to a logarithmic scaling. \-If you want to use \hyperlink{classQCPColorMap}{\-Q\-C\-P\-Color\-Map} with logarithmic axes, you shouldn't use the \hyperlink{classQCPColorMapData_ac96d6e84befe7b9951b5da6d4d4a2a47}{\-Q\-C\-P\-Color\-Map\-Data\-::cell\-To\-Coord} method as it uses a linear transformation to determine the cell index.
\end{DoxyNote}
\begin{DoxySeeAlso}{\-See also}
...
\index{clear@{clear}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{clear}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::clear} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\index{coord\-To\-Cell@{coord\-To\-Cell}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{coord\-To\-Cell}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::coord\-To\-Cell} (
\begin{DoxyParamCaption}
\item[{double}]{key, }
\item[{double}]{value, }
...
\begin{DoxyNote}{\-Note}
\-The \hyperlink{classQCPColorMap}{\-Q\-C\-P\-Color\-Map} always displays the data at equal key/value intervals, even if the key or value axis is set to a logarithmic scaling. \-If you want to use \hyperlink{classQCPColorMap}{\-Q\-C\-P\-Color\-Map} with logarithmic axes, you shouldn't use the \hyperlink{classQCPColorMapData_a26e33c5ec7094b60136350bcd77d3737}{\-Q\-C\-P\-Color\-Map\-Data\-::coord\-To\-Cell} method as it uses a linear transformation to determine the cell index.
\end{DoxyNote}
\begin{DoxySeeAlso}{\-See also}
...
\index{fill@{fill}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{fill}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::fill} (
\begin{DoxyParamCaption}
\item[{double}]{z}
\end{DoxyParamCaption}
...
\index{is\-Empty@{is\-Empty}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{is\-Empty}]{\setlength{\rightskip}{0pt plus 5cm}bool {\bf \-Q\-C\-P\-Color\-Map\-Data\-::is\-Empty} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{classQCPColorMapData_a986009324aee1fc5f696db46bd03dde5}
...
\index{operator=@{operator=}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
...
\index{recalculate\-Data\-Bounds@{recalculate\-Data\-Bounds}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{recalculate\-Data\-Bounds}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::recalculate\-Data\-Bounds} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\index{set\-Cell@{set\-Cell}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{set\-Cell}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::set\-Cell} (
\begin{DoxyParamCaption}
\item[{int}]{key\-Index, }
\item[{int}]{value\-Index, }
\item[{double}]{z}
...
\-Sets the data of the cell with indices {\itshape key\-Index\/} and {\itshape value\-Index\/} to {\itshape z\/}. \-The indices enumerate the cells starting from zero, up to the map's size-\/1 in the respective dimension (see \hyperlink{classQCPColorMapData_a0d9ff35c299d0478b682bfbcdd9c097e}{set\-Size}).
...
\index{set\-Data@{set\-Data}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{set\-Data}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::set\-Data} (
\begin{DoxyParamCaption}
\item[{double}]{key, }
\item[{double}]{value, }
\item[{double}]{z}
...
\begin{DoxyNote}{\-Note}
\-The \hyperlink{classQCPColorMap}{\-Q\-C\-P\-Color\-Map} always displays the data at equal key/value intervals, even if the key or value axis is set to a logarithmic scaling. \-If you want to use \hyperlink{classQCPColorMap}{\-Q\-C\-P\-Color\-Map} with logarithmic axes, you shouldn't use the \hyperlink{classQCPColorMapData_afd2083ccfd6987ec94aa7ef8e91ca39a}{\-Q\-C\-P\-Color\-Map\-Data\-::set\-Data} method as it uses a linear transformation to determine the cell index. \-Rather directly access the cell index with \hyperlink{classQCPColorMapData_a8e75eaf8746596319032a93f3d2d0683}{\-Q\-C\-P\-Color\-Map\-Data\-::set\-Cell}.
\end{DoxyNote}
\begin{DoxySeeAlso}{\-See also}
...
\index{set\-Key\-Range@{set\-Key\-Range}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{set\-Key\-Range}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::set\-Key\-Range} (
\begin{DoxyParamCaption}
\item[{const {\bf \-Q\-C\-P\-Range} \&}]{key\-Range}
\end{DoxyParamCaption}
...
\index{set\-Key\-Size@{set\-Key\-Size}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{set\-Key\-Size}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::set\-Key\-Size} (
\begin{DoxyParamCaption}
\item[{int}]{key\-Size}
\end{DoxyParamCaption}
...
\index{set\-Range@{set\-Range}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{set\-Range}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::set\-Range} (
\begin{DoxyParamCaption}
\item[{const {\bf \-Q\-C\-P\-Range} \&}]{key\-Range, }
\item[{const {\bf \-Q\-C\-P\-Range} \&}]{value\-Range}
\end{DoxyParamCaption}
...
\index{set\-Size@{set\-Size}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{set\-Size}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::set\-Size} (
\begin{DoxyParamCaption}
\item[{int}]{key\-Size, }
\item[{int}]{value\-Size}
\end{DoxyParamCaption}
...
\index{set\-Value\-Range@{set\-Value\-Range}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{set\-Value\-Range}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::set\-Value\-Range} (
\begin{DoxyParamCaption}
\item[{const {\bf \-Q\-C\-P\-Range} \&}]{value\-Range}
\end{DoxyParamCaption}
...
\index{set\-Value\-Size@{set\-Value\-Size}!QCPColorMapData@{\-Q\-C\-P\-Color\-Map\-Data}}
\subsubsection[{set\-Value\-Size}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Color\-Map\-Data\-::set\-Value\-Size} (
\begin{DoxyParamCaption}
\item[{int}]{value\-Size}
\end{DoxyParamCaption}
