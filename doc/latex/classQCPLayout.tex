...
\-This is an abstract base class for layout elements whose main purpose is to define the position and size of other child layout elements. \-In most cases, layouts don't draw anything themselves (but there are exceptions to this, e.\-g. \hyperlink{classQCPLegend}{\-Q\-C\-P\-Legend}).
...
\-Since this is an abstract base class, you can't instantiate it directly. \-Rather use one of its subclasses like \hyperlink{classQCPLayoutGrid}{\-Q\-C\-P\-Layout\-Grid} or \hyperlink{classQCPLayoutInset}{\-Q\-C\-P\-Layout\-Inset}.
...
\subsubsection[{\-Q\-C\-P\-Layout}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Q\-C\-P\-Layout\-::\-Q\-C\-P\-Layout} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}explicit\mbox{]}}}}\label{classQCPLayout_a04222e6e1361fd802d48f1a25b7020d4}
\-Creates an instance of \hyperlink{classQCPLayout}{\-Q\-C\-P\-Layout} and sets default values. \-Note that since \hyperlink{classQCPLayout}{\-Q\-C\-P\-Layout} is an abstract base class, it can't be instantiated directly. 
...
\subsubsection[{clear}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Layout\-::clear} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{element\-At}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Q\-C\-P\-Layout\-Element} $\ast$ {\bf \-Q\-C\-P\-Layout\-::element\-At} (
\begin{DoxyParamCaption}
\item[{int}]{index}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}}\label{classQCPLayout_afa73ca7d859f8a3ee5c73c9b353d2a56}
...
\subsubsection[{element\-Count}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf \-Q\-C\-P\-Layout\-::element\-Count} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}}\label{classQCPLayout_a39d3e9ef5d9b82ab1885ba1cb9597e56}
...
\subsubsection[{elements}]{\setlength{\rightskip}{0pt plus 5cm}\-Q\-List$<$ {\bf \-Q\-C\-P\-Layout\-Element} $\ast$ $>$ {\bf \-Q\-C\-P\-Layout\-::elements} (
\begin{DoxyParamCaption}
\item[{bool}]{recursive}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}\label{classQCPLayout_a51fe2675b53e829130b229bc1f7b0f99}
...
\subsubsection[{remove}]{\setlength{\rightskip}{0pt plus 5cm}bool {\bf \-Q\-C\-P\-Layout\-::remove} (
\begin{DoxyParamCaption}
...
\-This function internally uses \hyperlink{classQCPLayout_a5a79621fa0a6eabb8b520cfc04fb601a}{take\-At} to remove the element from the layout and then deletes the element. \-Note that some layouts don't remove the respective cell right away but leave an empty cell after successful removal of the layout element. \-To collapse empty cells, use \hyperlink{classQCPLayout_a41e6ac049143866e8f8b4964efab01b2}{simplify}.
...
\subsubsection[{remove\-At}]{\setlength{\rightskip}{0pt plus 5cm}bool {\bf \-Q\-C\-P\-Layout\-::remove\-At} (
\begin{DoxyParamCaption}
\item[{int}]{index}
\end{DoxyParamCaption}
...
\-This function internally uses \hyperlink{classQCPLayout_a5a79621fa0a6eabb8b520cfc04fb601a}{take\-At} to remove the element from the layout and then deletes the returned element. \-Note that some layouts don't remove the respective cell right away but leave an empty cell after successful removal of the layout element. \-To collapse empty cells, use \hyperlink{classQCPLayout_a41e6ac049143866e8f8b4964efab01b2}{simplify}.
...
\subsubsection[{simplify}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Layout\-::simplify} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}\label{classQCPLayout_a41e6ac049143866e8f8b4964efab01b2}
...
\-Not all layouts need simplification. \-For example, \hyperlink{classQCPLayoutInset}{\-Q\-C\-P\-Layout\-Inset} doesn't use explicit simplification while \hyperlink{classQCPLayoutGrid}{\-Q\-C\-P\-Layout\-Grid} does. 
...
\subsubsection[{size\-Constraints\-Changed}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Layout\-::size\-Constraints\-Changed} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}\label{classQCPLayout_a6218cd7e5c0e30077c1aeaffe55b6145}
\-Subclasses call this method to report changed (minimum/maximum) size constraints.

\-If the parent of this layout is again a \hyperlink{classQCPLayout}{\-Q\-C\-P\-Layout}, forwards the call to the parent's \hyperlink{classQCPLayout_a6218cd7e5c0e30077c1aeaffe55b6145}{size\-Constraints\-Changed}. \-If the parent is a \-Q\-Widget (i.\-e. is the \hyperlink{classQCustomPlot_afd280d4d621ae64a106543a545c508d7}{\-Q\-Custom\-Plot\-::plot\-Layout} of \hyperlink{classQCustomPlot}{\-Q\-Custom\-Plot}), calls \-Q\-Widget\-::update\-Geometry, so if the \hyperlink{classQCustomPlot}{\-Q\-Custom\-Plot} widget is inside a \-Qt \-Q\-Layout, it may update itself and resize cells accordingly. \hypertarget{classQCPLayout_ada26cd17e56472b0b4d7fbbc96873e4c}{\index{\-Q\-C\-P\-Layout@{\-Q\-C\-P\-Layout}!take@{take}}
\index{take@{take}!QCPLayout@{\-Q\-C\-P\-Layout}}
\subsubsection[{take}]{\setlength{\rightskip}{0pt plus 5cm}bool {\bf \-Q\-C\-P\-Layout\-::take} (
\begin{DoxyParamCaption}
\item[{{\bf \-Q\-C\-P\-Layout\-Element} $\ast$}]{element}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}}\label{classQCPLayout_ada26cd17e56472b0b4d7fbbc96873e4c}
...
\-Note that some layouts don't remove the respective cell right away but leave an empty cell after successful removal of the layout element. \-To collapse empty cells, use \hyperlink{classQCPLayout_a41e6ac049143866e8f8b4964efab01b2}{simplify}.
...
\subsubsection[{take\-At}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Q\-C\-P\-Layout\-Element} $\ast$ {\bf \-Q\-C\-P\-Layout\-::take\-At} (
\begin{DoxyParamCaption}
\item[{int}]{index}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}}\label{classQCPLayout_a5a79621fa0a6eabb8b520cfc04fb601a}
...
\subsubsection[{update}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Q\-C\-P\-Layout\-::update} (
\begin{DoxyParamCaption}
\item[{{\bf \-Update\-Phase}}]{phase}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}\label{classQCPLayout_a34ab477e820537ded7bade4399c482fd}
