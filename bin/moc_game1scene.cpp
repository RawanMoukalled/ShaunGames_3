...
**
** Created: Thu Apr 13 22:22:26 2017
...
static const char qt_meta_stringdata_Game1Scene[] = {
    "Game1Scene\0\0Done(bool)\0move_line()\0"
};
...
void Game1Scene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->move_line(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Game1Scene::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Game1Scene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_Game1Scene,
      qt_meta_data_Game1Scene, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Game1Scene::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Game1Scene))
